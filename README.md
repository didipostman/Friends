...
Friends for Linux
----------------------
Install Last Linux Ubuntu or RedHat version on your PC  and do not forget to patch Kernel when needed and do not forget to install firewall for your Linux PC example https://www.ipfire.org/
